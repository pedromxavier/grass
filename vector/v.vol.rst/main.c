...
int main(int argc, char *argv[])
{
    ...
    parm.scol->description = _("Name of column with smoothing parameters");
    ...
    parm.gradient->description =
        _("Name for output gradient magnitude 3D raster map");
    ...
    parm.aspect2->description =
        _("Name for output gradient vertical angle 3D raster map");
    ...
    parm.ncurv->description =
        _("Name for output change of gradient 3D raster map");
    ...
    parm.gcurv->description =
        _("Name for output Gaussian curvature 3D raster map");
