...
class TestTemporalRasterAlgebraConditionals(TestCase):
    ...
    def test_temporal_conditional_1(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression="R = if(td(A) == 1,  D * 2, D)", basename="r", overwrite=True
        )
    ...
    def test_spatial_conditional_1(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression="R = if(A > 1 && A < 4 && isntnull(A), A)",
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatial_conditional_2(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression="R = if(A > 1 && A < 4 && isntnull(A), A, null())",
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatial_conditional_5(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression="R = if(B > 5 {&&,contains,l} A < 5, B)",
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatial_conditional_relation_1(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression="R = if({contains},B > 5, D)", basename="r", overwrite=True
        )
    ...
    def test_spatial_conditional_relation_2(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression="R = if({contains}, B <= 5, A, A * 2)",
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatial_conditional_numeric_relation_1(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression="R = if({contains}, B > 5, A, 10)", basename="r", overwrite=True
        )
    ...
    def test_spatiotemporal_conditional_1(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if(A < 2 && start_date(A) < "2001-01-03", A)',
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_2(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if(A < 3 || start_date(A) < "2001-01-04", A + 1, A - 1)',
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_relation_1(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression="R = if({contains},B > 5 && start_day(B) < 3, D)",
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_relation_2(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if({contains}, start_date(B) < "2001-01-03" || B <= 5, A, A * 2)',
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_numeric_relation_1(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if({contains}, start_date(B) >= "2001-01-03" && B > 5, A, 10)',
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_numeric_relation_2(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if({contains},td(B) == 2 && start_date(B) == "2001-01-03" && B > 5 , A + 2 / 4.0)',
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_numeric_1(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if(start_date(A) < "2001-01-04" && A > 2, 0, A)',
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_numeric_2(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if(A > 2 || start_date(A) > "2001-01-01" && start_date(A) < "2001-01-04", A, 8)',
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_numeric_3(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if(start_date(A) < "2001-01-04" && A > 2, 1, 0)',
            basename="r",
            overwrite=True,
        )
    ...
    def test_spatiotemporal_conditional_numeric_4(self):
        ...
        tra = tgis.TemporalRasterAlgebraParser(run=True, debug=True)
        tra.parse(
            expression='R = if(A > 2 || start_date(A) > "2001-01-01", null())',
            basename="r",
            overwrite=True,
        )
