...
/* new systems: FLT_MAX, DBL_MAX, old systems: MAXFLOAT, MAXDOUBLE,
 * fallback: 3.4E38 and 1.79E308f */
#ifdef FLT_MAX
...
int export_band(GDALDatasetH, int, const char *, const char *,
                struct Cell_head *, RASTER_MAP_TYPE, double, int, int, int,
                double, double);
int exact_checks(GDALDataType, const char *, const char *, struct Cell_head *,
                 RASTER_MAP_TYPE, double, const char *, int);

/* attr.c */
int export_attr(GDALDatasetH, int, const char *, const char *, RASTER_MAP_TYPE);
