...
class ProfileRasterDialog(wx.Dialog):
    ...
    def _do_layout(self):
        ...
        box.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(0, 0))
        ...
        sizer.Add(box, proportion=0, flag=wx.ALL, border=10)

        line = wx.StaticLine(
            parent=self, id=wx.ID_ANY, size=(20, -1), style=wx.LI_HORIZONTAL
        )
        sizer.Add(line, proportion=0, flag=wx.GROW | wx.LEFT | wx.RIGHT, border=5)
...
class ScatterRasterDialog(wx.Dialog):
    ...
    def _do_layout(self):
        ...
        # Nsteps for FP maps
        label = StaticText(
            parent=self, id=wx.ID_ANY, label=_("Number of bins (for FP maps)")
        )
        ...
        box.Add(self.spinbins, flag=wx.ALIGN_CENTER_VERTICAL, pos=(1, 1))
...
class PlotStatsFrame(wx.Frame):
    def __init__(
        self, parent, id, message="", title="", style=wx.DEFAULT_FRAME_STYLE, **kwargs
    ):
        ...
        statstitle = StaticText(parent=self.panel, id=wx.ID_ANY, label=self.title)
        sizer.Add(statstitle, proportion=0, flag=wx.GROW | wx.ALL, border=3)
        line = wx.StaticLine(
            parent=self.panel, id=wx.ID_ANY, size=(20, -1), style=wx.LI_HORIZONTAL
        )
        sizer.Add(line, proportion=0, flag=wx.GROW | wx.ALL, border=3)
        for stats in self.message:
            statstxt = StaticText(parent=sp, id=wx.ID_ANY, label=stats)
            statstxt.SetBackgroundColour("WHITE")
            txtSizer.Add(
                statstxt, proportion=1, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=3
            )
            line = wx.StaticLine(
                parent=sp, id=wx.ID_ANY, size=(20, -1), style=wx.LI_HORIZONTAL
            )
            txtSizer.Add(line, proportion=0, flag=wx.GROW | wx.ALL, border=3)
        ...
        sizer.Add(
            sp, proportion=1, flag=wx.GROW | wx.LEFT | wx.RIGHT | wx.BOTTOM, border=3
        )
        ...
        btn_clipboard.SetToolTip(_("Copy regression statistics the clipboard (Ctrl+C)"))
        btnSizer.Add(btn_clipboard, proportion=0, flag=wx.ALL, border=5)

        btnCancel = Button(self.panel, wx.ID_CLOSE)
        btnCancel.SetDefault()
        btnSizer.Add(btnCancel, proportion=0, flag=wx.ALL, border=5)

        sizer.Add(btnSizer, proportion=0, flag=wx.ALL, border=5)
...
class HistRasterDialog(wx.Dialog):
    ...
    def _do_layout(self):
        ...
        self.rasterRadio = wx.RadioButton(
            self,
            id=wx.ID_ANY,
            label=" %s " % _("Histogram single raster"),
            style=wx.RB_GROUP,
        )
        self.groupRadio = wx.RadioButton(
            self, id=wx.ID_ANY, label=" %s " % _("Histogram imagery group")
        )
        if self.maptype == "raster":
            self.rasterRadio.SetValue(True)
        elif self.maptype == "group":
            self.groupRadio.SetValue(True)
        box.Add(self.rasterRadio, flag=wx.ALIGN_CENTER_VERTICAL, pos=(0, 0))
        box.Add(self.groupRadio, flag=wx.ALIGN_CENTER_VERTICAL, pos=(0, 1))

        #
        # Select a raster to histogram
        #
        label = StaticText(parent=self, id=wx.ID_ANY, label=_("Select raster map:"))
        box.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(1, 0))
        self.rselection = Select(
            self, id=wx.ID_ANY, size=globalvar.DIALOG_GSELECT_SIZE, type="cell"
        )
        ...
        #
        label = StaticText(parent=self, id=wx.ID_ANY, label=_("Select image group:"))
        box.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(2, 0))
        self.gselection = Select(
            self, id=wx.ID_ANY, size=globalvar.DIALOG_GSELECT_SIZE, type="group"
        )
        ...
        box.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(3, 0))
        self.spinbins = SpinCtrl(
            parent=self,
            id=wx.ID_ANY,
            value="",
        ...
        self.spinbins.SetRange(1, 1000)
        self.spinbins.SetValue(self.bins)
        box.Add(self.spinbins, flag=wx.ALIGN_CENTER_VERTICAL, pos=(3, 1))

        label = StaticText(parent=self, id=wx.ID_ANY, label=_("Histogram type"))
        box.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(4, 0))
        ...
        box.Add(histtype, flag=wx.ALIGN_CENTER_VERTICAL, pos=(4, 1))
    ...
    def OnGroupSelection(self, event):
        ...
        ret = (
            grass.read_command(
                "i.group", group="%s" % self.group, quiet=True, flags="g"
            )
            .strip()
            .splitlines()
        )
...
class TextDialog(wx.Dialog):
    ...
    def _do_layout(self):
        ...
        box = StaticBox(parent=self, id=wx.ID_ANY, label=" %s " % _("Text settings"))
        ...
        # profile title
        #
        label = StaticText(parent=self, id=wx.ID_ANY, label=_("Profile title:"))
        gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(0, 0))
        self.ptitleentry = TextCtrl(parent=self, id=wx.ID_ANY, value="", size=(250, -1))
        ...
        #
        tlabel = StaticText(
            parent=self, id=wx.ID_ANY, label=_("Title font size (pts):")
        )
        ...
        # x-axis label
        #
        label = StaticText(parent=self, id=wx.ID_ANY, label=_("X-axis label:"))
        gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(2, 0))
        self.xlabelentry = TextCtrl(parent=self, id=wx.ID_ANY, value="", size=(250, -1))
        ...
        # y-axis label
        #
        label = StaticText(parent=self, id=wx.ID_ANY, label=_("Y-axis label:"))
        gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(3, 0))
        self.ylabelentry = TextCtrl(parent=self, id=wx.ID_ANY, value="", size=(250, -1))
        ...
        #
        llabel = StaticText(
            parent=self, id=wx.ID_ANY, label=_("Label font size (pts):")
        )
        ...
        # font family
        #
        label1 = StaticText(parent=self, id=wx.ID_ANY, label=_("Font family:"))
        ...
        sizer.Add(boxSizer, flag=wx.LEFT | wx.RIGHT | wx.BOTTOM | wx.EXPAND, border=3)
        ...
        btnSizer.Add(btnStdSizer, proportion=0, flag=wx.ALL, border=5)
        sizer.Add(btnSizer, proportion=0, flag=wx.ALL, border=5)
...
class OptDialog(wx.Dialog):
    ...
    def _do_layout(self):
        ...
        box = StaticBox(parent=self, id=wx.ID_ANY, label=_("Map/image plotted"))
        boxSizer = wx.StaticBoxSizer(box, wx.VERTICAL)
        ...
        gridSizer.Add(
            self.mapchoice, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0), span=(1, 2)
        )
        ...
        if self.plottype != "scatter":
            row += 1
            label = StaticText(parent=self, id=wx.ID_ANY, label=_("Line color"))
            gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0))
            color = ColourSelect(
                parent=self, id=wx.ID_ANY, colour=self.raster[self.map]["pcolor"]
            )
            self.wxId["pcolor"] = color.GetId()
            gridSizer.Add(color, pos=(row, 1))

            row += 1
            label = StaticText(parent=self, id=wx.ID_ANY, label=_("Line width"))
            gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0))
            width = SpinCtrl(
                parent=self,
                id=wx.ID_ANY,
            ...
            row += 1
            label = StaticText(parent=self, id=wx.ID_ANY, label=_("Line style"))
            gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0))
            style = Choice(
                parent=self,
                id=wx.ID_ANY,
                size=(120, -1),
                choices=list(self.linestyledict.keys()),
            )
        ...
        gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0))
        legend = TextCtrl(parent=self, id=wx.ID_ANY, value="", size=(200, -1))
        ...
        if self.plottype == "profile":
            ...
            ptcolor = ColourSelect(
                parent=self, id=wx.ID_ANY, colour=self.properties["marker"]["color"]
            )
            ...
            ptfill = Choice(
                ...
                id=wx.ID_ANY,
                size=(120, -1),
                choices=list(self.ptfilldict.keys()),
            )
            ...
            label = StaticText(parent=self, id=wx.ID_ANY, label=_("Legend"))
            gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(3, 0))
            ptlegend = TextCtrl(parent=self, id=wx.ID_ANY, value="", size=(200, -1))
            ptlegend.SetValue(self.properties["marker"]["legend"])
            self.wxId["marker"]["legend"] = ptlegend.GetId()
            gridSizer.Add(ptlegend, pos=(3, 1))

            label = StaticText(parent=self, id=wx.ID_ANY, label=_("Style"))
            gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(4, 0))
            pttype = Choice(parent=self, size=(200, -1), choices=self.pttypelist)
        ...
        #
            ...
            box = StaticBox(
                parent=self, id=wx.ID_ANY, label=" %s " % _("Scatterplot points")
            )
        ...
        #
        box = StaticBox(parent=self, id=wx.ID_ANY, label=" %s " % _("Axis settings"))
        boxMainSizer = wx.StaticBoxSizer(box, wx.HORIZONTAL)
        ...
        for axis, atype in [(_("X-Axis"), "x-axis"), (_("Y-Axis"), "y-axis")]:
            box = StaticBox(parent=self, id=wx.ID_ANY, label=" %s " % axis)
            ...
            gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0))
            type = Choice(
                parent=self, id=wx.ID_ANY, size=(100, -1), choices=self.axislist
            )
            ...
            row += 1
            label = StaticText(parent=self, id=wx.ID_ANY, label=_("Custom min"))
            gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0))
            min = TextCtrl(parent=self, id=wx.ID_ANY, value="", size=(70, -1))
            min.SetValue(str(prop["min"]))
            self.wxId[atype]["min"] = min.GetId()
            gridSizer.Add(min, pos=(row, 1))

            row += 1
            label = StaticText(parent=self, id=wx.ID_ANY, label=_("Custom max"))
            gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0))
            max = TextCtrl(parent=self, id=wx.ID_ANY, value="", size=(70, -1))
        ...
        self.wxId["font"] = {}
        box = StaticBox(
            parent=self, id=wx.ID_ANY, label=" %s " % _("Grid and Legend settings")
        )
        boxMainSizer = wx.StaticBoxSizer(box, wx.HORIZONTAL)
        gridSizer = wx.GridBagSizer(vgap=5, hgap=5)
        ...
        gridcolor = ColourSelect(
            parent=self, id=wx.ID_ANY, colour=self.properties["grid"]["color"]
        )
        ...
        row += 1
        label = StaticText(parent=self, id=wx.ID_ANY, label=_("Legend font size"))
        gridSizer.Add(label, flag=wx.ALIGN_CENTER_VERTICAL, pos=(row, 0))
        legendfontsize = SpinCtrl(
            parent=self, id=wx.ID_ANY, value="", size=(50, -1), style=wx.SP_ARROW_KEYS
        )
        ...
        row += 1
        legendshow = CheckBox(parent=self, id=wx.ID_ANY, label=_("Show legend"))
        ...
        middleSizer.Add(
            boxMainSizer, flag=wx.LEFT | wx.RIGHT | wx.BOTTOM | wx.EXPAND, border=3
        )
    ...
    def OnSetMap(self, event):
        ...
        self.FindWindowById(self.wxId["pcolor"]).SetColour(
            self.raster[self.map]["pcolor"]
        )
        self.FindWindowById(self.wxId["plegend"]).SetValue(
            self.raster[self.map]["plegend"]
        )

        # update settings controls for histograms and profiles
        if self.plottype != "scatter":
            self.FindWindowById(self.wxId["pwidth"]).SetValue(
                self.raster[self.map]["pwidth"]
            )
            self.FindWindowById(self.wxId["pstyle"]).SetStringSelection(
                self.raster[self.map]["pstyle"]
            )

        # update settings controls for scatterplots
        elif self.plottype == "scatter":
            self.FindWindowById(self.wxId["psize"]).SetValue(
                self.raster[self.map]["psize"]
            )
            self.FindWindowById(self.wxId["ptype"]).SetStringSelection(
                self.raster[self.map]["ptype"]
            )
            self.FindWindowById(self.wxId["pfill"]).SetStringSelection(
                self.raster[self.map]["pfill"]
            )
    ...
    def UpdateSettings(self):
        ...
        self.raster[self.map]["pcolor"] = (
            self.FindWindowById(self.wxId["pcolor"]).GetColour().Get()
        )
        ...
        if self.plottype != "scatter":
            self.raster[self.map]["pwidth"] = int(
                self.FindWindowById(self.wxId["pwidth"]).GetValue()
            )
            ...
            self.raster[self.map]["psize"] = self.FindWindowById(
                self.wxId["psize"]
            ).GetValue()
        ...
        if self.plottype == "profile":
            self.properties["marker"]["color"] = (
                self.FindWindowById(self.wxId["marker"]["color"]).GetColour().Get()
            )
            self.properties["marker"]["fill"] = self.FindWindowById(
                self.wxId["marker"]["fill"]
            ).GetStringSelection()
            self.properties["marker"]["size"] = self.FindWindowById(
                self.wxId["marker"]["size"]
            ).GetValue()
            self.properties["marker"]["type"] = self.FindWindowById(
                self.wxId["marker"]["type"]
            ).GetStringSelection()
            self.properties["marker"]["legend"] = self.FindWindowById(
                self.wxId["marker"]["legend"]
            ).GetValue()

        self.properties["grid"]["color"] = (
            self.FindWindowById(self.wxId["grid"]["color"]).GetColour().Get()
        )
