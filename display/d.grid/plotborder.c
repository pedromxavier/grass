...
int plot_border(double grid_size, double east, double north, int direction)
{
    ...
    /* plot boundary lines: */
    /* horizontal : */
    D_line_abs(window.west, window.south, window.east + colm_dist,
               window.south); /* display lib bug? */
        ...
        while (x <= window.east) {
            ...
            for (i = 0; i <= grid_size; i = i + steps) {
                ...
                if (loop == 0) {
                    D_line_abs(x + i,
                               window.south +
                                   (window.north - window.south) / longmark,
                               x + i, window.south);
                    D_line_abs(x + i, window.north, x + i,
                               window.north - row_dist -
                                   (window.north - window.south) / longmark);
                }
                if (loop == 5) {
                    D_line_abs(x + i,
                               window.south +
                                   (window.north - window.south) / middlemark,
                               x + i, window.south);
                    D_line_abs(x + i, window.north, x + i,
                               window.north - row_dist -
                                   (window.north - window.south) / middlemark);
                    ...
                    D_line_abs(x + i,
                               window.south +
                                   (window.north - window.south) / shortmark,
                               x + i, window.south);
                    D_line_abs(x + i, window.north, x + i,
                               window.north - row_dist -
                                   (window.north - window.south) / shortmark);
            ...
            for (i = 0; i <= grid_size; i = i + steps) {
                ...
                if (loop == 0) {
                    D_line_abs(window.west, y + i,
                               window.west +
                                   (window.east - window.west) / longmark,
                               y + i);
                ...
                if (loop == 5) {
                    ...
                    D_line_abs(window.west, y + i,
                               window.west +
                                   (window.east - window.west) / shortmark,
                               y + i);
                    D_line_abs(window.east -
                                   (window.east - window.west) / shortmark,
                               y + i, window.east, y + i);
