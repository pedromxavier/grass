...
/* histogram.c */
double histogram(const char *, int, int, int, int, int, int, int, int, int,
                 struct FPRange, int);
...
void draw(const char *, int, int, int, int, int, int, int, int, int, int, int,
          int, struct Categories, struct Colors, double, double, double, double,
          int, int, double, double, double *, int, int, int, double, double,
          const char *, double *, double, int, int, struct Option *,
