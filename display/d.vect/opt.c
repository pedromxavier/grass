...
void options_to_lattr(LATTR *lattr, const char *layer, const char *color,
                      const char *bgcolor, const char *bcolor, int size,
                      const char *font, const char *encoding, const char *xref,
                      const char *yref)
{
    int r, g, b;
