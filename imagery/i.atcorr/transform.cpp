...
double transform(const TransformInput &ti, InputMask imask, double idn)
{
    ...
    if ((imask & ETM_BEFORE) || (imask & ETM_AFTER)) {
        ...
        /* multiply idn by 255.f to correct precondition that idn lies in [0,
         * 255] */
    ...
    if (imask & RADIANCE)
        idn += (double)M_PI * idn * 255.f * ti.sb / ti.xmus / ti.seb;
    ...
    */
    ...
    /*
    xa = (double)M_PI * ti.sb / ti.xmus / ti.seb / ti.tgasm / ti.sutott /
    ti.sdtott; xb = ti.srotot / ti.sutott / ti.sdtott / ti.tgasm; xc = ti.sast;
    */
