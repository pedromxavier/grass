...
/*
   ...
   upward and total paths. We consider the six gases (O2, CO2, H 2O, O3, N 2O
   and CH4) separately. The total transmission is put equal to the simple
   product of each ones. The spectral resolution is equal to 10 cm-1. iinf */
