 ...
 * 1100 -> class 6: internal constant used in place of climatological data for
 * at least one atmospheric constant 1101 -> class 7: correction out of bounds,
 * pixel constrained to extreme allowable value 1110 -> class 8: L1B data faulty
