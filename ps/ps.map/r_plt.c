...
int read_point(double e, double n)
{
    ...
    static char *help[] = {
        "color  color", "fcolor fill color", "symbol group/symbol", "size   #",
        "width  #",     "rotate #",          "masked [y|n]",        ""};
...
int read_eps(double e, double n)
{
    ...
    static char *help[] = {"epsfile EPS file", "scale   #", "rotate   #",
                           "masked [y|n]", ""};
...
int read_line(double e1, double n1, double e2, double n2)
{
    ...
    static char *help[] = {"color  color", "width  #", "masked [y|n]", ""};
...
int read_rectangle(double e1, double n1, double e2, double n2)
{
    ...
    static char *help[] = {"color  color", "fcolor fill color", "width  #",
                           "masked [y|n]", ""};
